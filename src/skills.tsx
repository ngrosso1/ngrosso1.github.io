  ...
  const categories: SkillCategory[] = [
    {
      ...
      skills: [
        ...
        { name: 'HTML5/CSS', icon: 'https://upload.wikimedia.org/wikipedia/commons/thumb/1/10/CSS3_and_HTML5_logos_and_wordmarks.svg/960px-CSS3_and_HTML5_logos_and_wordmarks.svg.png', framed: false },
      ],
    },
    {
      title: 'Back End',
      skills: [
        { name: 'C/C++', icon: 'https://www.vikingsoftware.com/wp-content/uploads/2024/02/C-2.png', framed: false },
        ...
        { name: 'C#', icon: 'https://cdn.prod.website-files.com/6047a9e35e5dc54ac86ddd90/63065002cd563e1cd1cead28_eaadfe64.png', framed: false },
    ...
    },
    {
      ...
      skills: [
        ...
        { name: 'postgreSQL', icon: 'https://trivenisiteasset.blob.core.windows.net/trivenisiteasset-container/2024/11/PostgreSQL-1.png', framed: false },
    ...
    },
    {
      ...
      skills: [
        ...
        { name: 'Jenkins', icon: 'https://wiki.jenkins-ci.org/JENKINS/attachments/2916393/57409617.png', framed: false },
